 ...
 * ---------------------------------
 * Cada beneficio corre su propio backend en su red local. La IP va en clientes.json
 ...
 *
 * Con el override, quien instala corrige la dirección desde el drawer y sigue.
 *
