 ...
 * recibidor entraba, trabajaba, y nadie se enteraba de que su clave estaba
 ...
 * Se muestra igual porque la alternativa es que el recibidor pruebe claves a
...
export function CambiarClaveScreen() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      // App.tsx deja de montar esta pantalla y el recibidor vuelve a lo suyo,
      // con la misma sesion.
    } catch (e) {
 ...
 * exacto cae siempre al default y le muestra al recibidor el code crudo.
 */
